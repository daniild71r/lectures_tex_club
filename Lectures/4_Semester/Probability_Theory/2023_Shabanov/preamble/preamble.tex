...
\newcommand{\CourseName}{Теория вероятности}
\newcommand{\FullCourseNameFirstPart}{\so{ТЕОРИЯ ВЕРОЯТНОСТИ}}
\newcommand{\SemesterNumber}{IV}
\newcommand{\LecturerInitials}{Дмитрий Александрович Шабанов}

...
\newcommand{\CourseName}{Основы вероятности и теории мер}
\newcommand{\FullCourseNameFirstPart}{\so{ОСНОВЫ ВЕРОЯТНОСТИ И ТЕОРИИ МЕР}}
\newcommand{\SemesterNumber}{III}
\newcommand{\LecturerInitials}{Иван Генрихович Эрлих}

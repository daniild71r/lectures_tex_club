...
\newcommand{\AuthorInitials}{Головко Денис}
\newcommand{\AuthorInitialssecond}{Фёдор Стуров}
\newcommand{\VKLink}{https://vk.com/golovko_denis}
\newcommand{\VKLinksecond}{https://vk.com/why_bububu}

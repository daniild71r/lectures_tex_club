...
\newcommand{\CourseName}{Introduction to Programming and Algorithms}
\newcommand{\FullCourseNameFirstPart}{\so{INTRODUCTION TO PROGRAMMING AND ALGORITHMS}}
\newcommand{\SemesterNumber}{I}
\newcommand{\LecturerInitials}{Ruhovich Phillip}

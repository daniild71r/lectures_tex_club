...
\begin{definition}
	Пусть $M \subseteq X$. Элемент $x \in M$ называется \textit{точкой прикосновения множества $M$}, если пересечение любого шара с центром в $x$ и $M$ непусто:
	\[
...
\begin{definition}
	Множество $A \subseteq X$ называется \textit{нигде не плотным}, если в замыкании множества $A$ нет ни одного открытого множества.
\end{definition}

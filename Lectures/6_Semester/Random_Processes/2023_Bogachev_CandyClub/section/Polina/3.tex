\begin{definition}\textit{Распределением} случаного процесса \textit{X} называется вероятностная мера $P_{X}$, заданная на пространстве тракеторий $\R^T$, определенная на $\beta_{T}$
по правилу $\forall B \in \beta_{T}$ $$ P_{X}(B) = P(\{w : t \rightarrow X_{t}(w) \in B \})$$ .
\end{definition}
...
\end{enumerate}
\begin{note}
    Если набор распределений $\{P_{t_1...t_n}: t_i \in T, n\in \N\}$ удовлетворяет свойствам 1 и 2, то говорят, что он удовлетворяет условиям симметрии и согласованности
\end{note}
\end{lemma}
\begin{proof}
\begin{enumerate}
...
Пусть $T \subset \R$ - любое.  $ \forall n \in \N, \forall t_1, ...,  t_n, t_i \in T $ задана вероятностная мера $P_{t_1...t_n}$ на ($\R^n$, $\B(\R^n)$).
...
\begin{theorem}
    \textbf{Теорема (условия симметрии и согласованности для хар. функций)} \\
    Пусть $T \subset \R$ - любое.  $ \forall n  \in \N, \forall t_1, ...,  t_n, t_i \in T $ задана вероятностная мера $P_{t_1...t_n}$ и соответствующая хар. функция $\phi_{t_1...t_n}$. Тогда набор мер  $\{P_{t_1...t_n}: t_i \in T, n\in \N\}$ удовлетворяет условиям симметрии и согласованности $\Longleftrightarrow$ хар. функции  $\{\phi_{t_1...t_n}: t_i \in T, n\in \N\}$ удовлетворяют следующим
...
Пусть $T \subset \R$ - любое.  $ \forall n  \in \N, \forall t_1 <...< t_n, t_i \in T $ задана хар. функция $\phi_{t_1...t_n}$, причём набор $\{\phi_{t_1...t_n}: t_i \in T, n\in \N\}$

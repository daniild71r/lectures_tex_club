...
\begin{definition}
	...
	\[
		\ke I = \{g \in G \such \forall \omega \in \Omega\ \ g\omega = \omega\}
	\]
\end{definition}
...
\begin{note}
	Если $w_1$ и $w_2$ эквивалентны, то $G(w_1) = G(w_2)$ по уже доказанному утверждению. Говорят, что всё $\Omega$ разбивается на орбиты; множество классов обозначатеся через $\Omega \bs G$.
\end{note}

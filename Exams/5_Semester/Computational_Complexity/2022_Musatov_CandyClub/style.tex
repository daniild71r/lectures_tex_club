...
\newcommand{\psp}{\textbf{PSPACE} }
\newcommand{\npsp}{\textbf{NPSPACE} }
\newcommand{\lsp}{\textbf{L} }
\newcommand{\nlsp}{\textbf{NL} }
\newcommand{\conlsp}{\textbf{coNL} }
\newcommand{\nlcsp}{\textbf{NLC} }
\newcommand{\nc}{\textbf{NC} }
\newcommand{\bpp}{\textbf{BPP} }
\newcommand{\rl}{\textbf{RL} }
\newcommand{\bpl}{\textbf{BPL} }
\newcommand{\rp}{\textbf{RP} }
\newcommand{\corp}{\textbf{coRP} }
\newcommand{\zpp}{\textbf{ZPP} }
\newcommand{\pp}{\textbf{PP} }
\newcommand{\ap}{\textbf{AP} }
\newcommand{\ppoly}{\p/_{\mathrm{poly}}}
\newcommand{\rclass}{\textbf{R} }
\newcommand{\re}{\textbf{RE} } %-- имя занято

\newcommand{\sk}[1]{\textbf{$\Sigma_{#1}^p$} }
\newcommand{\pk}[1]{\textbf{$\Pi_{#1}^p$} }
\newcommand{\skp}[1]{\textbf{$\Sigma_{#1}$P} }
\newcommand{\pkp}[1]{\textbf{$\Pi_{#1}$P} }
\newcommand{\dtime}[1]{\textbf{DTIME}\brackets{#1}}
\newcommand{\ntime}[1]{\textbf{NTIME}\brackets{#1}}
\newcommand{\atime}[1]{\textbf{ATIME}\brackets{#1}}
\newcommand{\sktime}[2]{\textbf{$\Sigma_{#1}$TIME}\brackets{#2}}
\newcommand{\pktime}[2]{\textbf{$\Pi_{#1}$TIME}\brackets{#2}}
\newcommand{\dsp}[1]{\textbf{DSPACE}\brackets{#1}}
\newcommand{\nsp}[1]{\textbf{NSPACE}\brackets{#1}}
\newcommand{\acd}[1]{\textbf{$\mathbf{AC}^{#1}$}}
\newcommand{\ncd}[1]{\textbf{$\mathbf{NC}^{#1}$}}
\newcommand{\adtime}[2]{\textbf{$\mathbf{DTIME}\brackets{#1}/_{#2}$}}


\newcommand{\sat}{\mathsf{SAT}}
\newcommand{\tqbf}{\mathsf{TQBF}}
\newcommand{\clique}{\mathsf{CLIQUE}}
\newcommand{\indset}{\mathsf{INDSET}}
\newcommand{\dhampath}{\mathsf{DHAMPATH}}
\newcommand{\uhampath}{\mathsf{UHAMPATH}}
\newcommand{\subsetsum}{\mathsf{SUBSET-SUM}}
\newcommand{\vertexcover}{\mathsf{VERTEXCOVER}}
\newcommand{\col}{\mathsf{COL}}
\newcommand{\tree}{\mathsf{TREE}}
\newcommand{\PATH}{\mathsf{PATH}}
\newcommand{\maxcut}{\mathsf{MAXCUT}}
\newcommand{\GG}{\mathsf{GG}}
\newcommand{\uhalt}{\mathsf{UHALT}}
\newcommand{\pksat}[1]{\text{$\Pi_{#1}$}\mathsf{SAT} }

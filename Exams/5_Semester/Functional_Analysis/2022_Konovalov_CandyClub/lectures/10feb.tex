...
\textbf{Применение теоремы 7.1 в приложениях}
...
\begin{itemize}
    ...
    Рассмотрим $y_n = \frac 1 n x_n \weakconv 0$, так как $f(y_n) = f(\frac 1 n x_n ) =\frac{1}{n} f(x_n) \to 0$ в силу слабой ограниченности $x_n$. Откуда по теореме~\ref{thm7_1} $\{ \| \frac 1 n x_n \| \}$ - ограничена, что противоречит выбору $x_n$.
\end{itemize}
\end{proof}

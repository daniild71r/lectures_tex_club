\subsection{3 февраля. Слабая сходимость}
...
\begin{enumerate}
    ...
    По следствию 3 из теоремы Хана-Банаха \(x' = x''\).
    ...
    \begin{itemize}
        ...
        Причем \(y_n\) стремится к нулю как член сходящегося ряда. Откуда получаем, что $e^n \weakconv 0$.
        \end{counterexample}
    ...
    \begin{theorem}[7.1]\label{thm7_1}
        ...
        \text{2) $\forall s \in S \subset E^*: [S] = E^*,\;\; s(x_n) \to s(x )$}\\
        \end{cases}\]
    \end{theorem}

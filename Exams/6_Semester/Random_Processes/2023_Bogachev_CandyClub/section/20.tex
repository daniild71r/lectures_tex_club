...
\begin{enumerate}
    ...
    \item $\mathbb{E} \eta_1 = a > 0$ и $ c - \lambda a > 0$
\end{enumerate}
\begin{lemma}
...
\end{enumerate}
\begin{theorem}
Пусть  $ c - \lambda a > 0$,  $\psi(v) = \mathbb{E}e^{v\eta_t} < \infty$ $\forall v > 0$, $g(v) = \lambda (\psi(v) - 1) - vc$, $v_0$ - единственный корень уравнения $g(v) = 0$ из $(0, +\infty)$. Тогда
